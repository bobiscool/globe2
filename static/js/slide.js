/**
 * Created by mac WuYiPing on 17/2/8.
 */
    "use strict";
    ...
    function Plugin($container, options) {
        ...
        var self = this
            ...
            ,   $scrollbar = $body.querySelectorAll(".scrollbar")[0]
            ,   $slide_bg = $body.querySelectorAll(".slide-bg")[0]
        ...
        this.update = function(scrollTo) {
            ...
            $slide_bg.className = this.hasContentToSroll ? scrcls.replace(/disable/g, "") : scrcls.replace(/ disable/g, "") + " disable";
